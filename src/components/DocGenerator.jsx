...
import { FileText, Download, Copy, Check, Presentation, Code, Printer, Sparkles, ArrowRight, ArrowLeft } from 'lucide-react';
    ...
    <div className="space-y-8 animate-fadeIn">
        ...
        <div className="flex justify-between items-start flex-wrap gap-4">
          ...
          <div className="flex flex-wrap space-x-2 gap-y-2">
            ...
            >
              ...
              <span>{downloadingPpt ? "Generating..." : t.downloadPpt}</span>
            </button>
      ...
      <div className="glass-panel p-6 sm:p-8 rounded-2xl space-y-6 border border-purple-500/30">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-slate-400 font-mono">{t.slide} {activeSlideIndex + 1} of {slides.length}</span>
        </div>
